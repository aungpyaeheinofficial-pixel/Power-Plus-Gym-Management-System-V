...
import { Search, Plus, Camera, Edit, Trash2, Package, Image as ImageIcon, X, Check, Filter, LayoutGrid, List, AlertTriangle } from 'lucide-react';
import { Product } from '../types';

export const Inventory: React.FC = () => {
  const { products, addProduct, updateProduct, deleteProduct, productCategories } = useApp();
    ...
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-3 w-full md:w-auto items-center">
             <div className="bg-dark-900 border border-white/10 rounded-xl px-2 flex items-center">
                <Filter size={16} className="text-gray-500 ml-2" />
                <select 
                    value={categoryFilter}
                    onChange={(e) => setCategoryFilter(e.target.value)}
                    className="bg-transparent text-white text-sm font-medium py-3 pl-2 pr-8 outline-none cursor-pointer"
                >
